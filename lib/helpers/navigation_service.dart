...
final class NavigationService {
  ...
  static Future<dynamic> navigateToReplacementwithArg(
          String routeName, Map<String, dynamic>? map) =>
      navigatorKey.currentState!
          .pushReplacementNamed(routeName, arguments: map);
  ...
  static void goBack() {
    log('[NavigationService] ✅ goBack() called — popping current route');
    navigatorKey.currentState!.pop();
  }

  static bool goBeBack() {
