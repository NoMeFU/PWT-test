...
final class DioSingleton {
  ...
  void create() {
    final lang = appData.read(kKeyCountryCode) ?? NetworkConstants.ACCEPT_LANGUAGE_VALUE;
    log('[DioSingleton] ✅ create() — baseUrl: $url, lang: $lang, App-Key present: ${NetworkConstants.APP_KEY_VALUE.isNotEmpty}');
    BaseOptions options = BaseOptions(
        ...
        headers: {
          ...
          NetworkConstants.ACCEPT_LANGUAGE: lang,
  ...
  void update(String auth) {
    final lang = appData.read(kKeyLanguage) ?? NetworkConstants.ACCEPT_LANGUAGE_VALUE;
    log('[DioSingleton] ✅ update() — lang: $lang, auth token present: ${auth.isNotEmpty}');
    BaseOptions options = BaseOptions(
      baseUrl: url,
