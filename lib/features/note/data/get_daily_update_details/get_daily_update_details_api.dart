...
class GetDailyUpdateDetailsAPI {
  static final GetDailyUpdateDetailsAPI _singleton =
      GetDailyUpdateDetailsAPI._internal();
  GetDailyUpdateDetailsAPI._internal();

  // * Singleton getter
  static GetDailyUpdateDetailsAPI get instance => _singleton;

  // * Method to fetch profile data
  Future<GetDailyUpdateModel> getUpdateDetailsAPI(
      ) async {
    try {
      Response response = await getHttp(
        Endpoints.dailyUpdateDetails(),
      );
