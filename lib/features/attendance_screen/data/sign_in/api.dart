...
final class AttendanceApi {
  static final AttendanceApi _singleton = AttendanceApi._internal();

  AttendanceApi._internal();

  static AttendanceApi get instance => _singleton;

  Future<Map<String, dynamic>> attendanceApiData({
